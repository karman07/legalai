        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/10">
          ...
          {isResetPassword && (
            <div className="mb-6">
              ...
              <p className="text-slate-400 text-sm">Your identity has been verified. Please set your new password below.</p>
            </div>
          )}

          {isForgotPassword && (
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-white mb-2">Recover Account</h2>
              <p className="text-slate-400 text-sm">Enter your email and we'll send a themed legal recovery link.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl font-medium transition-all ${registrationType === 'personal'
                    ...
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl font-medium transition-all ${registrationType === 'institute'
                        ? 'bg-amber-500 text-white shadow-lg'
                        : 'bg-slate-800/50 text-slate-300 border border-slate-600/50 hover:border-amber-500/50'
                        }`}
                    >
            ...
            {error && (
              <div className="bg-red-500/10 border border-red-500/50 rounded-xl px-4 py-3 flex flex-col gap-2">
                <div className="flex items-start gap-3">
                ...
                {showVerificationAction && (
                  <div className="flex flex-col gap-2 ml-8">
                    <button
                      ...
                      className="text-xs font-bold text-amber-400 hover:underline text-left"
                    >
                    ...
                    <button
                      ...
                      className="text-xs font-bold text-amber-500 hover:underline text-left"
                    >
                    ...
                    <button
                      ...
                      className="text-xs font-bold text-amber-500/80 hover:underline text-left"
                    >
                      Forgot password?
                    </button>
                  </div>
